// import '@/style/mainlogin/border.css';
// import '@/style/mainlogin/switch.css';
// import '@/style/mainlogin/loader.css';
        ...
        <div className="text-center">
          ...
          <div className="flex justify-between w-full max-w-screen-lg mx-auto">
            <div className="flex-1 flex flex-col items-center p-2">
              ...
              <span className="colortext mt-2 text-lg font-semibold">
                {t('ICU')}
              </span>
            </div>
            <div className="flex-1 flex flex-col items-center p-2">
